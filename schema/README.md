...
Recognition distribution uses:

- `recognition-channel-pointer-1.0.0.schema.json`;
- `recognition-stable-release-1.0.0.schema.json`;
- `recognition-approval-record-1.0.0.schema.json`.
